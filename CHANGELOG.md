...
## v1.12.1
### Fixed
* [CVE-2026-26016](https://github.com/shadowdactyl/panel/security/advisories/GHSA-g7vw-f8p5-c728)
* [GHSA-hr7j-63v7-vj7g](https://github.com/shadowdactyl/panel/security/advisories/GHSA-hr7j-63v7-vj7g)
...
* [CVE-2025-69197](https://github.com/shadowdactyl/panel/security/advisories/GHSA-rgmp-4873-r683)
* [CVE-2025-69198](https://github.com/shadowdactyl/panel/security/advisories/GHSA-jw2v-cq5x-q68g)
...
* Fixes allocation notes not being reset when a server is deleted. ([#5157](https://github.com/shadowdactyl/panel/pull/5157))
...
### Fixed
* Multiple XSS vulnerabilities in the admin area ([GHSA-384w-wffr-x63q](https://github.com/shadowdactyl/panel/security/advisories/GHSA-384w-wffr-x63q))
...
## v1.6.6
### Fixed
* **[security]** Fixes a CSRF vulnerability for both the administrative test email endpoint and node auto-deployment token generation endpoint. [GHSA-wwgq-9jhf-qgw6](https://github.com/shadowdactyl/panel/security/advisories/GHSA-wwgq-9jhf-qgw6)
...
* **[Security]** Addresses a Client API vulnerability that would allow a user to list all servers on the system ([`GHSA-6888-7f3w-92jx`](https://github.com/shadowdactyl/panel/security/advisories/GHSA-6888-7f3w-92jx))
