...
**Shadowdactyl does not accept Pull Requests (PRs) _for new functionality_** that was not previously approved by project
...
If you use any type of AI assistance while developing for Shadowdactyl **it must be disclosed** within the
...
our [GitHub Discussions](https://github.com/orgs/shadowdactyl/discussions/categories/feature-requests)
for any feature requests, general questions, or help with the software.

You can also find us on [Discord](https://discord.gg/shadowdactyl).
